...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dpi.io_driving_current = LCM_DRIVING_CURRENT_2MA;//LCM_DRIVING_CURRENT_8MA | LCM_DRIVING_CURRENT_4MA | LCM_DRIVING_CURRENT_2MA;;
}
