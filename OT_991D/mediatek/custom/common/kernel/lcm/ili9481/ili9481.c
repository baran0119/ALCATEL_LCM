...
static void init_lcm_registers(void)
{
	...
	send_ctrl_cmd(0xD1);
	send_data_cmd(0x00);
	send_data_cmd(0x31);//vcomh 33
	send_data_cmd(0x13);//vdv
...
//Gamma2.5 setting
	send_ctrl_cmd(0xC8);
	send_data_cmd(0x30);//KP1[2:0];KP0[2:0]
	send_data_cmd(0X57);//KP3[2:0];KP2[2:0]
	send_data_cmd(0X05);//KP5[2:0];KP4[2:0]
	send_data_cmd(0X51);//21 RP1[2:0];RP0[2:0]
	send_data_cmd(0X0f);//0a 01VRP0[3:0]
	send_data_cmd(0X04);//04 16VRP1[4:0]
	send_data_cmd(0X27);//KN1[2:0];KN0[2:0]
	send_data_cmd(0X02);//KN3[2:0];KN2[2:0]
	send_data_cmd(0X74);//KN5[2:0];KN4[2:0]
	send_data_cmd(0X15);//13 RN1[2:0];RN0[2:0]
	send_data_cmd(0X02);//02 0a 06 06 VRN0[3:0]
