...
extern LCM_DRIVER nt35590_cmd_telsa_lcm_drv;
extern LCM_DRIVER lgld070wx3_dsi_vdo_lcm_drv;
extern LCM_DRIVER he080ia_lcm_drv;
extern LCM_DRIVER hx8394a_vdo_diabloalpha_lcm_drv;
extern LCM_DRIVER hx8394a_vdo_diabloalpha_second_lcm_drv;
extern LCM_DRIVER r63311_fhd_dsi_vedio_scribepro_lcm_drv;
extern LCM_DRIVER hx8394a_diabloalpha_third_lcm_drv;
extern LCM_DRIVER r63315_fhd_dsi_vedio_scribepro_lcm_drv;
extern LCM_DRIVER nt35596_scribepro_tdt_lcm_drv;
extern LCM_DRIVER nt35596_diablox_drv;

LCM_DRIVER* lcm_driver_list[] = 
{ 
#if defined(NT35596_DIABLOX)
	&nt35596_diablox_drv,
#endif

#if defined(HX8394A_THIRD)	
	&hx8394a_diabloalpha_third_lcm_drv,
#endif

#if defined(NT35596_SCRIBEPRO)
	&nt35596_scribepro_tdt_lcm_drv,
#endif

#if defined(R63311_SCRIBEPRO)//for new patch ,modify none	
	&r63311_fhd_dsi_vedio_scribepro_lcm_drv,
#endif

#if defined(R63315_SCRIBEPRO)//for new patch ,modify none	
	&r63315_fhd_dsi_vedio_scribepro_lcm_drv,
#endif

#if defined(HX8394A)	
	&hx8394a_vdo_diabloalpha_lcm_drv,
#endif

#if defined(HX8394A_SECOND)	
	&hx8394a_vdo_diabloalpha_second_lcm_drv,
#endif

#if defined(NT35590_CMD_TELSA)	
	&nt35590_cmd_telsa_lcm_drv,
#endif
