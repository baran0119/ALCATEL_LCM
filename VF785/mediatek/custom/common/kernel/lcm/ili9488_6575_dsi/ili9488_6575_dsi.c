...
/*
		...
		data_array[1]=0x000436F1; 
		data_array[2]=0xA40F0F3C;
		data_array[3]=0x00000002;
		dsi_set_cmdq(&data_array, 4, 1);
		MDELAY(10);

		data_array[0]=0x000A3902;
		data_array[1]=0x12A318F2;
		data_array[2]=0xFF12B202;
		data_array[3]=0x00000010;
		dsi_set_cmdq(&data_array, 4, 1);
		MDELAY(10);

		data_array[0]=0x00073902;
		data_array[1]=0x2D91A9F7;
		data_array[2]=0x00004C8A;
		dsi_set_cmdq(&data_array, 3, 1);
		MDELAY(10);

		data_array[0]=0x00033902;
		data_array[1]=0x000421F8; 
		dsi_set_cmdq(&data_array, 2, 1);
		MDELAY(10);

		data_array[0]=0x00033902;
		data_array[1]=0x000800F9; 
		dsi_set_cmdq(&data_array, 2, 1);
		MDELAY(10);

		data_array[0]=0x00063902;
		data_array[1]=0x080000F4;
		data_array[2]=0x00000491;
		dsi_set_cmdq(&data_array, 3, 1);
		MDELAY(10);

		data_array[0]=0x48361500;
		...
		data_array[0]=0x00033902;
		data_array[1]=0x000222B6;
		dsi_set_cmdq(&data_array, 2, 1);
		MDELAY(10);

		data_array[0]=0x86B71500;
		dsi_set_cmdq(&data_array, 1, 1);
		MDELAY(10);

		data_array[0]=0x00033902;
		data_array[1]=0x000F0FC0;
		dsi_set_cmdq(&data_array, 2, 1);
		MDELAY(10);
		...
		data_array[0]=0x00033902;
		data_array[1]=0x004700C5;
		dsi_set_cmdq(&data_array, 2, 1);
		MDELAY(10);

		data_array[0]=0x00103902;
		data_array[1]=0x33340FE0;
		data_array[2]=0x4B030306;
		data_array[3]=0x080E2C66;
		data_array[4]=0x00000103;
		dsi_set_cmdq(&data_array, 5, 1);
		MDELAY(10);

		data_array[0]=0x00103902;
		data_array[1]=0x3A3F0FE1;
		data_array[2]=0x3D010709;
		data_array[3]=0x0D063869;
		data_array[4]=0x001E2506;
		dsi_set_cmdq(&data_array, 5, 1);
		MDELAY(10);
