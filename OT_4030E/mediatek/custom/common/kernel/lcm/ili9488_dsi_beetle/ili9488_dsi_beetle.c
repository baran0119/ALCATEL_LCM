...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	*/
	{0x35,	1,	{0x00}},
	{0xE0,	15,	{0x00, 0x11, 0x1B, 0x0C, 0x0D, 0x0B, 0x31, 0x7A, 0x41, 0x09, 0x0E,0x0A, 0x0F, 0x0C, 0x0F}},
	{0xE1,	15,	{0x00, 0x0D, 0x17, 0x02, 0x10, 0x07, 0x2B, 0x45, 0x3C, 0x01, 0x05,0x08, 0x33, 0x3F, 0x0F}},
	{0xC0,	2,	{0x10, 0x10}},
	{0xC1,	1,	{0x41}},
	{0xC5,	3,	{0x00, 0x62, 0x80}},
	{0x36,	1,	{0x48}},
	{0x3A,	1,	{0x77}},
	{0xB0,	1,	{0x00}},
	{0xB1,	2,	{0xB0, 0x11}},
...
static unsigned int lcm_esd_check(void)
{
     ...
     if ((buffer_vcom[0]==0x00)&&(buffer_vcom[1]==0x62)&&(buffer_vcom[3]==0x62)){
...
static unsigned int lcm_compare_id(void)
{
	...
	#ifdef BUILD_UBOOT
	      printf("lcm ili9488 id is %x,%x,%x,%x, id = %d--------------\n", buffer_vcom[0], buffer_vcom[1] ,buffer_vcom[2], buffer_vcom[3], id);
	#endif

      if ((buffer_vcom[3]==0x88 && id == 0)){
               return 1;
     }else{
              return 0;
   }
