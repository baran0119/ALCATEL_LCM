...
extern LCM_DRIVER ili9486_dsi_beetle_lcm_drv;

extern LCM_DRIVER nt35512_smartiii_lcm_drv;
extern LCM_DRIVER nt35510_smartiii_lcm_drv;
...
{ 
#if defined(ILI9486_DSI_BEETLE)
		&ili9486_dsi_beetle_lcm_drv,
#endif
...
#if defined(NT35510_WVGA_DSI_CMD_SMARTIII)
    &nt35510_smartiii_lcm_drv,
#endif

#if defined(NT35512_WVGA_DSI_VDO_SMARTIII)
   &nt35512_smartiii_lcm_drv,
#endif
