...
extern LCM_DRIVER nt35512_dsi_vdo_tdta1_lcm_drv;
extern LCM_DRIVER nt35512_dsi_vdo_tdt_lcm_drv;
extern LCM_DRIVER nt35516_lcm_drv;
extern LCM_DRIVER hx8389b_dsi_vdo_lcm_drv;
extern LCM_DRIVER RX_50NT_408A_lcm_drv;
extern LCM_DRIVER ej070na_lcm_drv;
extern LCM_DRIVER ili9806c_dsi_vdo_byd_lcm_drv;
...
#if defined(NT35512_DSI_VDO_TDTA1)
	&nt35512_dsi_vdo_tdta1_lcm_drv, 
#endif

#if defined(NT35512_DSI_VDO_TDT)
	&nt35512_dsi_vdo_tdt_lcm_drv, 
#endif
...
#if defined(HX8389B_6577_VDO)
	&hx8389b_dsi_vdo_lcm_drv,
#endif

#if defined(EJ070NA)
	&ej070na_lcm_drv,
#endif
#if defined(ILI9806C_DSI_VDO_BYD)
	&ili9806c_dsi_vdo_byd_lcm_drv,
#endif
};
